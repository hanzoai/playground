...
// NodeClient defines the interface for communicating with agent nodes
type NodeClient interface {
	...
	ShutdownNode(ctx context.Context, nodeID string, graceful bool, timeoutSeconds int) (*NodeShutdownResponse, error)

	// GetBotStatus retrieves detailed status information from an agent node
	GetBotStatus(ctx context.Context, nodeID string) (*BotStatusResponse, error)
}
...
// NodeShutdownResponse represents the response from requesting agent shutdown
...
// BotStatusResponse represents detailed status information from an agent
