...
import (
	...
	"github.com/hanzoai/playground/internal/cloud"
	"github.com/hanzoai/playground/internal/config"
	"github.com/hanzoai/playground/internal/core/interfaces"
	coreservices "github.com/hanzoai/playground/internal/core/services" // Core services
	"github.com/hanzoai/playground/internal/events"                     // Event system
	"github.com/hanzoai/playground/internal/handlers"                   // Agent handlers
	"github.com/hanzoai/playground/internal/handlers/ui"                // UI handlers
	"github.com/hanzoai/playground/internal/infrastructure/communication"
	"github.com/hanzoai/playground/internal/infrastructure/process"
	infrastorage "github.com/hanzoai/playground/internal/infrastructure/storage"
	"github.com/hanzoai/playground/internal/gitops"
	"github.com/hanzoai/playground/internal/gossip"
	"github.com/hanzoai/playground/internal/kms"
	"github.com/hanzoai/playground/internal/logger"
	"github.com/hanzoai/playground/internal/policy"
	"github.com/hanzoai/playground/internal/proxy"
	"github.com/hanzoai/playground/internal/server/middleware"
	"github.com/hanzoai/playground/internal/services" // Services
	"github.com/hanzoai/playground/internal/spaces"
	"github.com/hanzoai/playground/internal/storage"
	"github.com/hanzoai/playground/internal/tasks"
	"github.com/hanzoai/playground/internal/utils"
	zappool "github.com/hanzoai/playground/internal/zap"
	client "github.com/hanzoai/playground/web/client"
...
func (s *PlaygroundServer) registerSpaceRoutes(spacesAPI *gin.RouterGroup) {
	...
	spacesAPI.GET("/:id/bots/:bid/policy", policyHandlers.GetBotPolicy)
	spacesAPI.PUT("/:id/bots/:bid/policy", policyHandlers.UpdateBotPolicy)
