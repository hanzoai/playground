...
Use this context to understand the product's architecture, terminology, and common use cases. This helps you provide more accurate answers and explain technical concepts correctly. For example, when users ask about 'identity', you know they're asking about DIDs and VCs. When they ask about 'functions', you understand they might mean bots or skills.
