...
**Agent Primitives:**
- **Bots**: AI-guided decision making functions (use LLMs for judgment)
...
- Understanding bots vs skills
- Basic agent structure and configuration

**Agent Development:**
- Registering bots and skills
...
- **Core Concepts**: Bots, skills, memory, identity, cross-agent communication
...
- "Functions" or "endpoints" → Look for: bots, skills, API endpoints
...
- "SDK" or "language" or "languages" or "supported" → Look for: Python SDK, Go SDK, TypeScript SDK, npm install @hanzo/playground, pip install hanzo-playground
"""
