...
> **[Full Documentation](https://hanzo.bot/examples/complete-agents/rag-evaluator)** — Detailed architecture diagrams, API examples, and deployment guides.
...
|----------|-------------|---------|
| `PLAYGROUND_URL` | Control plane URL | `http://localhost:8080` |
