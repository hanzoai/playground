...
- Quick mode: 4-6 AI calls (single bot per metric)
- Standard mode: 10-14 AI calls (multi-bot patterns)
...
def register_orchestrator_bots(router):
    """Register orchestrator bots with the router."""
    ...
    async def evaluate_rag_response(
        ...
        - quick: Fast single-bot evaluation (4-6 AI calls)
        - standard: Multi-bot patterns (10-14 AI calls)
    ...
    async def evaluate_quick(
        ...
        """
        Quick evaluation mode: Single bot per metric.

        Workflow: 4 parallel single-bot evaluations
        AI calls: 4 total
        Latency: ~1-2s
        ...
        router.note("Quick mode: 4 parallel single-bot evaluations",
    ...
    async def evaluate_standard(
        ...
        """
        Standard evaluation mode: Multi-bot patterns.

        Workflow: 4 parallel metric evaluations, each with internal multi-bot
        ...
        router.note("Standard mode: Multi-bot patterns",
