...
def register_hallucination_bots(router):
    """Register all hallucination-related bots with the router."""

    # ============================================
    # STATEMENT EXTRACTION (ML-based skill + bot wrapper)
    # ============================================
    ...
    def extract_statements_ml(response: str) -> dict:
        ...
        This is a SKILL (not bot) because it's deterministic ML.
        """
        try:
    ...
    async def extract_statements(
        ...
        """
        Statement extraction bot (wraps ML skill).
...
Focus on claims containing: facts, numbers, dates, names, specific assertions.""",
    ...
    async def verify_statements_ml(
        ...
        """
        ML verification bot (creates workflow node).
...
- confidence: 0.0-1.0 how confident in this assessment""",
    ...
    async def evaluate_hallucination_quick(
        ...
        """
        Quick single-bot hallucination check.
