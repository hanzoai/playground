...
from playground.logger import log_error
...
async def generate_image_litellm(
    ...
    **kwargs,
    ...
    try:
        ...
        from playground.multimodal_response import detect_multimodal_response
...
async def generate_image_openrouter(
    ...
    **kwargs,
    ...
    from playground.multimodal_response import ImageOutput, MultimodalResponse
