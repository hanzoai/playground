"""
Playground SDK Connection Manager

Provides resilient connection handling for Playground server connectivity.
...
from playground.logger import log_debug, log_info, log_warn, log_error


class ConnectionState(Enum):
    """Connection states for Playground server connectivity"""

    DISCONNECTED = "disconnected"
    CONNECTING = "connecting"
    CONNECTED = "connected"
    RECONNECTING = "reconnecting"
    DEGRADED = "degraded"  # Running locally without Playground server
...
class ConnectionManager:
    """
    Manages resilient connections to Playground server with automatic reconnection,
    graceful degradation, and health monitoring.

    Uses a simple, consistent retry interval to ensure immediate reconnection
    when Playground server becomes available.
    """
    ...
    async def _attempt_connection(self) -> bool:
        """
        Attempt to connect to Playground server.
        ...
        try:
            ...
            log_debug("Attempting connection to Playground server")

            # Try to register with Playground server - suppress verbose error logging
            import logging
    ...
    def is_connected(self) -> bool:
        """Check if currently connected to Playground server"""
