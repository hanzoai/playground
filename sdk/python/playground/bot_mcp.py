...
from playground.types import BotStatus, MCPServerHealth
...
class BotMCP:
    ...
    async def initialize_mcp(self):
        ...
        """
        try:
            agent_dir = self._detect_bot_directory()
    ...
    def _create_and_register_mcp_skill(
        ...
        """
        Create and register a single MCP tool as a Playground skill.
        ...
        skill_name = BotUtils.generate_skill_name(server_alias, tool_name)
        ...
        Args:
            execution_context (ExecutionContext, optional): Playground execution context for workflow tracking
        ...
        input_schema = BotUtils.create_input_schema_from_mcp_tool(skill_name, tool)
        ...
        try:
            ...
            if self.agent.mcp_manager:
                ...
                if successful == total and total > 0:
                    self.agent._current_status = BotStatus.READY
                elif successful > 0:
                    self.agent._current_status = BotStatus.DEGRADED
                else:
