...
class DynamicMCPSkillManager:
    """
    Dynamic MCP Skill Generator that converts MCP tools into Playground skills.

    This class discovers MCP servers, lists their tools, and dynamically
    registers each tool as a Playground skill with proper schema generation
    ...
    def __init__(self, agent, dev_mode: bool = False):
        ...
        Args:
            agent: The Playground agent instance
    ...
    async def discover_and_register_all_skills(self) -> None:
        """
        Discover and register all MCP tools as Playground skills.
        ...
        6. Registers each tool as a Playground skill
        """
    ...
    async def _register_mcp_tool_as_skill(
        ...
        """
        Register an MCP tool as a Playground skill.
