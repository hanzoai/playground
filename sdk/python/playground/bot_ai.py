...
from playground.logger import log_debug, log_error, log_warn
from playground.rate_limiter import StatelessRateLimiter
...
class BotAI:
    """AI/LLM Integration functionality for Playground Agent"""

    def __init__(self, agent_instance):
        """
        Initialize BotAI with a reference to the main agent instance.
    ...
    def _fal_provider(self):
        ...
        if self._fal_provider_instance is None:
            from playground.media_providers import FalProvider
    ...
    def _process_multimodal_args(self, args: tuple) -> List[Dict[str, Any]]:
        ...
        from playground.multimodal import Audio, File, Image, Text
        ...
        for arg in args:
            ...
            if isinstance(arg, Text):
                ...
                detected_type = BotUtils.detect_input_type(arg)
                ...
                if detected_type == "text":
                    ...
                    try:
                        ...
                        mime_type = BotUtils.get_mime_type(ext)
    ...
    async def _generate_openai_direct_audio(
        ...
        **kwargs,
        ...
        from playground.multimodal_response import AudioOutput, MultimodalResponse
