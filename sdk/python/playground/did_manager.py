...
class DIDManager:
    """
    Manages DID operations for Playground SDK agents.
    ...
    def __init__(
        self, agents_server_url: str, agent_node_id: str, api_key: Optional[str] = None
    ):
        """
    ...
    def register_agent(
        ...
        try:
            ...
            # Send registration request to Playground Server
