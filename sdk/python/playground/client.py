...
class PlaygroundClient:
    ...
    def __init__(
        ...
        if PlaygroundClient._shared_sync_session is None:
            PlaygroundClient._init_shared_sync_session()
    ...
    def register_node(self, node_data: Dict[str, Any]) -> Dict[str, Any]:
        """Register agent node with Playground server"""
    ...
    async def register_agent(
        ...
        """Register or update agent information with Playground server."""
        try:
            ...
            registration_data = {
                ...
                "metadata": {
                    "deployment": {
                        ...
                        "platform": "python",
                        "region": "local",
                        "tags": {"sdk_version": importlib.import_module("playground").__version__, "language": "python"},
                    },
    ...
    async def send_enhanced_heartbeat(
        ...
        """
        Send enhanced heartbeat with status and MCP information to Playground server.
    ...
    async def notify_graceful_shutdown(self, node_id: str) -> bool:
        """
        Notify Playground server that the agent is shutting down gracefully.
    ...
    async def close_async_execution_manager(self) -> None:
        ...
        This should be called when the PlaygroundClient is no longer needed
