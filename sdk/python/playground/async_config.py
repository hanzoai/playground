"""
Async execution configuration for the Playground SDK.
...
class AsyncConfig:
    ...
    def from_environment(cls) -> "AsyncConfig":
        ...
        Environment variables use the prefix AGENTS_ASYNC_ followed by the
        uppercase parameter name. For example:
        - AGENTS_ASYNC_MAX_EXECUTION_TIMEOUT=1800
        - AGENTS_ASYNC_BATCH_SIZE=50
        ...
        def get_env_var(name: str, default_value, converter=None):
            env_name = f"AGENTS_ASYNC_{name.upper()}"
