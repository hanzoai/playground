...
func TestRunCLI_ExecutesDefaultBot(t *testing.T) {
	b := newTestBot(t)

	b.RegisterBot("greet", func(ctx context.Context, input map[string]any) (any, error) {
	...
	stdout, stderr, err := captureOutput(t, func() error {
		return b.runCLI(context.Background(), []string{"--set", "name=Bob", "--output", "json"})
	})
