...
func NewConfigCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Configure environment variables for an installed Agents agent package",
		Long: `Configure environment variables for an installed Agents agent package.
...
func (pcm *PackageConfigManager) saveEnvFile(packagePath string, envVars map[string]string) error {
	...
	var lines []string
	lines = append(lines, "# Environment variables for Agents agent")
