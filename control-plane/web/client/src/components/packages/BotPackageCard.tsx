...
import { getConfigurationStatusBadge, getBotStatusBadge } from '../../services/configurationApi';
import type { BotPackage, BotLifecycleInfo } from '../../types/playground';

interface BotPackageCardProps {
  package: BotPackage;
  botStatus?: BotLifecycleInfo;
...
export const BotPackageCard: React.FC<BotPackageCardProps> = ({
  package: pkg,
  botStatus,
  onConfigure,
  onStart,
  ...
  const botStatusBadge = botStatus ? getBotStatusBadge(botStatus.status) : null;
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            {getStatusIcon()}
            {botStatusBadge && (
              <Badge variant={botStatusBadge.variant} className="text-xs">
          ...
          <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-red-600 mt-1">{botStatus.error_message}</p>
              </div>
            </div>
          </div>
        )}
