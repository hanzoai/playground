...
export function BotsSkillsTable({
  ...
  const isBotActive = botStatus
    ? botStatus.health_status === "active" &&
      (botStatus.lifecycle_status === "ready" || botStatus.lifecycle_status === "degraded")
    : false;

  const componentStatus: "active" | "inactive" = isBotActive ? "active" : "inactive";
