...
import type { NodeSummary, Node } from '../types/playground';
import {
  Table,
  TableBody,
  TableCell,
...
const NodesTable: React.FC<NodesTableProps> = ({ nodes, isLoading, error }) => {
  ...
  if (nodes.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground">No hanzo nodes are currently registered with the Playground server.</p>
      </div>
    );
  }
